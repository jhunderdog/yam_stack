...
*/
  ...
  YamNormalResponseTags({
    this.name,
  });
  YamNormalResponseTags.fromJson(Map<String, dynamic> json) {
...
*/
  ...
  YamNormalResponseFoods({
    this.name,
  });
  YamNormalResponseFoods.fromJson(Map<String, dynamic> json) {
    name = json["name"]?.toString();
  }
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = Map<String, dynamic>();
...
class YamNormalResponseRestaurant {
/*
{
  "id": 456,
  "apiId": "123456",
...
*/
  ...
  YamNormalResponseRestaurant.fromJson(Map<String, dynamic> json) {
    id = json["id"]?.toInt();
...
*/
  ...
  String? genTime;
  String? competeTime;
  YamNormalResponseRestaurant? restaurant;
  List<YamNormalResponseFoods?>? foods;
  List<YamNormalResponseTags?>? tags;
  String? memo;
  String? review;
  bool? good;
  ...
  YamNormalResponse.fromJson(Map<String, dynamic> json) {
    id = json["id"]?.toInt();
    genTime = json["genTime"]?.toString();
    competeTime = json["competeTime"]?.toString();
    restaurant = (json["restaurant"] != null) ? YamNormalResponseRestaurant.fromJson(json["restaurant"]) : null;
    if (json["foods"] != null) {
      final v = json["foods"];
      final arr0 = <YamNormalResponseFoods>[];
      v.forEach((v) {
        arr0.add(YamNormalResponseFoods.fromJson(v));
      });
      foods = arr0;
    }
    if (json["tags"] != null) {
      final v = json["tags"];
      final arr0 = <YamNormalResponseTags>[];
      v.forEach((v) {
        arr0.add(YamNormalResponseTags.fromJson(v));
      });
      tags = arr0;
    }
